 ...
 *
**********************************************************************/
//  sstDxf02Hatch.cpp   29.04.16  Re.   29.04.16  Re.
//
...
//=============================================================================
// Constructor
sstDxf02TypHatchCls::sstDxf02TypHatchCls()
{
  this->angle = 0.0;
  this->numLoops = 0;
  this->originX = 0.0;
...
//=============================================================================
// Set Test Data
int sstDxf02TypHatchCls::SetTestData(int iKey)
{
  if ( iKey != 0) return -1;
...
//=============================================================================
void sstDxf02TypHatchCls::ReadFromDL(const DL_HatchData oDLHatch)
{
...
//=============================================================================
void sstDxf02TypHatchCls::WritToDL(DL_HatchData *poDLHatch)
{
...
//=============================================================================
int sstDxf02TypHatchCls::getNumLoops() const
{
return numLoops;
}
//=============================================================================
void sstDxf02TypHatchCls::setNumLoops(int value)
{
numLoops = value;
}
//=============================================================================
bool sstDxf02TypHatchCls::getSolid() const
{
return solid;
}
//=============================================================================
void sstDxf02TypHatchCls::setSolid(bool value)
{
solid = value;
}
//=============================================================================
double sstDxf02TypHatchCls::getScale() const
{
return scale;
}
//=============================================================================
void sstDxf02TypHatchCls::setScale(double value)
{
scale = value;
}
//=============================================================================
double sstDxf02TypHatchCls::getAngle() const
{
return angle;
}
//=============================================================================
void sstDxf02TypHatchCls::setAngle(double value)
{
angle = value;
}
//=============================================================================
dREC04RECNUMTYP sstDxf02TypHatchCls::getPatternID() const
{
return dPatternID;
}
//=============================================================================
void sstDxf02TypHatchCls::setPatternID(const dREC04RECNUMTYP &value)
{
dPatternID = value;
}
//=============================================================================
double sstDxf02TypHatchCls::getOriginX() const
{
return originX;
}
//=============================================================================
void sstDxf02TypHatchCls::setOriginX(double value)
{
originX = value;
}
//=============================================================================
double sstDxf02TypHatchCls::getOriginY() const
{
return originY;
}
//=============================================================================
void sstDxf02TypHatchCls::setOriginY(double value)
{
originY = value;
}
//=============================================================================
// Constructor
sstDxf02FncHatchCls::sstDxf02FncHatchCls():sstDxf02FncBaseCls(sizeof(sstDxf02TypHatchCls))
{
  // this->poDxfArcMem = new sstRec04Cls(sizeof(sstDxf02TypHatchCls));
}
//=============================================================================
// Csv Read Function
...
//=============================================================================
// Csv Write Function
int sstDxf02FncHatchCls::Csv_Write(int iKey, sstDxf02TypHatchCls *poSstHatch, std::string *ssstDxfLib_Str)
{
  int iStat = 0;
...
//=============================================================================
int sstDxf02FncHatchCls::Csv_WriteHeader(int iKey, std::string *ssstDxfLib_Str)
{
...
//=============================================================================
int sstDxf02FncHatchCls::ReadCsvFile(int iKey, std::string oFilNam)
{
...
//=============================================================================
int sstDxf02FncHatchCls::WriteCsvFile(int iKey, std::string oDxfFilNam)
{
