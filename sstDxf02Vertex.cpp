 ...
 *
**********************************************************************/
//  sstDxf02Vertex.cpp   29.04.16  Re.   29.04.16  Re.
//
...
//=============================================================================
// Constructor
sstDxf02TypVertexCls::sstDxf02TypVertexCls()
{
  this->dRecordID = 0;
  this->dParentID = 0;
...
//=============================================================================
// Set Test Data
int sstDxf02TypVertexCls::SetTestData(int iKey)
{
  if ( iKey != 0) return -1;
...
//=============================================================================
void sstDxf02TypVertexCls::ReadFromDL(const DL_VertexData oDLVertex)
{
...
//=============================================================================
void sstDxf02TypVertexCls::WritToDL(DL_VertexData *poDLVertex)
{
...
//=============================================================================
dREC04RECNUMTYP sstDxf02TypVertexCls::getRecordID() const
{
return dRecordID;
}
//=============================================================================
void sstDxf02TypVertexCls::setRecordID(const dREC04RECNUMTYP &value)
{
dRecordID = value;
}
//=============================================================================
dREC04RECNUMTYP sstDxf02TypVertexCls::getParentID() const
{
return dParentID;
}
//=============================================================================
void sstDxf02TypVertexCls::setParentID(const dREC04RECNUMTYP &value)
{
dParentID = value;
}
//=============================================================================
RS2::EntityType sstDxf02TypVertexCls::getEntityType() const
{
return eEntityType;
}
//=============================================================================
void sstDxf02TypVertexCls::setEntityType(const RS2::EntityType &value)
{
eEntityType = value;
}
//=============================================================================
double sstDxf02TypVertexCls::getX() const
{
return x;
}
//=============================================================================
void sstDxf02TypVertexCls::setX(double value)
{
x = value;
}
//=============================================================================
double sstDxf02TypVertexCls::getY() const
{
return y;
}
//=============================================================================
void sstDxf02TypVertexCls::setY(double value)
{
y = value;
}
//=============================================================================
double sstDxf02TypVertexCls::getZ() const
{
return z;
}
//=============================================================================
void sstDxf02TypVertexCls::setZ(double value)
{
z = value;
}
//=============================================================================
double sstDxf02TypVertexCls::getBulge() const
{
return bulge;
}
//=============================================================================
void sstDxf02TypVertexCls::setBulge(double value)
{
bulge = value;
}
//=============================================================================
// Constructor
sstDxf02FncVertexCls::sstDxf02FncVertexCls():sstDxf02FncBaseCls(sizeof(sstDxf02TypVertexCls))
{
  // this->poDxfArcMem = new sstRec04Cls(sizeof(sstDxf02TypVertexCls));
}
//=============================================================================
// Csv Read Function
int sstDxf02FncVertexCls::Csv_Read(int iKey, std::string *oErrStr, std::string *ssstDxfLib_Str, sstDxf02TypVertexCls *osstDxf02TypVertexCls)
{
...
//  unsigned long ulTmpBlockID = 0;
  ...
  sstDxf02EntityTypeCls oEntType;
...
//=============================================================================
// Csv Write Function
int sstDxf02FncVertexCls::Csv_Write(int iKey, sstDxf02TypVertexCls *poSstVertex, std::string *ssstDxfLib_Str)
{

  if ( iKey != 0) return -1;

  int iStat = 0;
  sstDxf02EntityTypeCls oEntityCnvt;
...
//=============================================================================
int sstDxf02FncVertexCls::Csv_WriteHeader(int iKey, std::string *ssstDxfLib_Str)
{
...
//=============================================================================
int sstDxf02FncVertexCls::ReadCsvFile(int iKey, std::string oFilNam)
{
...
//=============================================================================
int sstDxf02FncVertexCls::WriteCsvFile(int iKey, std::string oDxfFilNam)
{
