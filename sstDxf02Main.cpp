 ...
 *
**********************************************************************/
// sstDxf02Main.cpp    12.04.16  Re.    12.04.16  Re.
//
...
//=============================================================================
sstDxf02TypMainCls::sstDxf02TypMainCls()
{
...
//=============================================================================
dREC04RECNUMTYP sstDxf02TypMainCls::getMainID() const
{
  return dMainID;
}
//=============================================================================
void sstDxf02TypMainCls::setMainID(const dREC04RECNUMTYP &value)
{
  dMainID = value;
}
//=============================================================================
std::string sstDxf02TypMainCls::getSectString() const
{
...
//=============================================================================
void sstDxf02TypMainCls::setSectString(const std::string &oSectString)
{
  strncpy(this->cSectionType,oSectString.c_str(),2);
}
//=============================================================================
dREC04RECNUMTYP sstDxf02TypMainCls::getLayBlockID() const
{
  return dLayBlockID;
}
//=============================================================================
void sstDxf02TypMainCls::setLayBlockID(const dREC04RECNUMTYP &value)
{
  dLayBlockID = value;
}
//=============================================================================
RS2::EntityType sstDxf02TypMainCls::getEntityType() const
{
  return eEntityType;
}
//=============================================================================
void sstDxf02TypMainCls::setEntityType(const RS2::EntityType &value)
{
  eEntityType = value;
}
//=============================================================================
dREC04RECNUMTYP sstDxf02TypMainCls::getTypeID() const
{
  return dTypeID;
}
//=============================================================================
void sstDxf02TypMainCls::setTypeID(const dREC04RECNUMTYP &value)
{
  dTypeID = value;
}
//=============================================================================
sstDxf02FncMainCls::sstDxf02FncMainCls():sstDxf02FncBaseCls(sizeof(sstDxf02TypMainCls))
{

}
//=============================================================================
// Csv Read Function
int sstDxf02FncMainCls::Csv_Read(int iKey,
                                 std::string *sErrTxt,
...
//-----------------------------------------------------------------------------
  ...
  {  // no read error until now
    ...
    osstDxf02TypMainCls->setMainID(dTmpNumber);
    osstDxf02TypMainCls->setSectString(oTmpSectString);
    osstDxf02TypMainCls->setLayBlockID(dTmpNumSect);
    osstDxf02TypMainCls->setEntityType(eEntityType);
    osstDxf02TypMainCls->setTypeID(dTmpNumType);
  }
  else
  {
...
//=============================================================================
// Csv Write Function
int sstDxf02FncMainCls::Csv_Write(int iKey,
                                  sstDxf02TypMainCls *poSstMain,
                                  std::string *ssstDxfLib_Str)
{
  int iStat = 0;
...
//=============================================================================
int sstDxf02FncMainCls::Csv_WriteHeader(int iKey, std::string *ssstDxfLib_Str)
{
...
//=============================================================================
int sstDxf02FncMainCls::ReadCsvFile(int iKey, std::string oFilNam)
{
