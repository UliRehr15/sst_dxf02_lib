...
//=============================================================================
void sstDxf02TypCircleCls::ReadFromDL(const DL_CircleData oDLCircle)
{
  this->cx = oDLCircle.cx;
  this->cy = oDLCircle.cy;
  this->cz = oDLCircle.cz;
  this->radius = oDLCircle.radius;
  // this->angle1 = oDLCircle.angle1;
  // this->angle2 = oDLCircle.angle2;
}
//=============================================================================
void sstDxf02TypCircleCls::WritToDL(DL_CircleData *poDLCircle)
{
  poDLCircle->cx = this->cx;
  poDLCircle->cy = this->cy;
  poDLCircle->cz = this->cz;
  poDLCircle->radius = this->radius;
  // poDLCircle->angle1 = this->angle1;
  // poDLCircle->angle2 = this->angle2;
}

double sstDxf02TypCircleCls::getCx() const
{
return cx;
}

void sstDxf02TypCircleCls::setCx(double value)
{
cx = value;
}

double sstDxf02TypCircleCls::getCy() const
{
return cy;
}

void sstDxf02TypCircleCls::setCy(double value)
{
cy = value;
}

double sstDxf02TypCircleCls::getCz() const
{
return cz;
}

void sstDxf02TypCircleCls::setCz(double value)
{
cz = value;
}

double sstDxf02TypCircleCls::getRadius() const
{
return radius;
}

void sstDxf02TypCircleCls::setRadius(double value)
{
radius = value;
}
...
//=============================================================================
int sstDxf02FncCircleCls::Csv_WriteHeader(int iKey, std::string *ssstDxfLib_Str)
{
...
//=============================================================================
//=============================================================================
int sstDxf02FncCircleCls::ReadCsvFile(int iKey, std::string oFilNam)
{
...
//=============================================================================
int sstDxf02FncCircleCls::WriteCsvFile(int iKey, std::string oDxfFilNam)
{
